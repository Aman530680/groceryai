  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-emerald-100 dark:from-gray-900 dark:to-gray-800 px-4">
      <div className="card p-8 w-full max-w-md animate-fade-in">
        ...
        {/* Quick login hints */}
        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3 mb-6 text-xs text-blue-700 dark:text-blue-300 space-y-1">
          <p className="font-semibold">Quick Login:</p>
          <p>🔑 Admin: <span className="font-mono">aman123@groceryai.com</span> / <span className="font-mono">aman123</span></p>
          <p>🚚 Delivery: <span className="font-mono">delivery123@groceryai.com</span> / <span className="font-mono">delivery123</span></p>
        </div>
